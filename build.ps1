...
$cp = $env:CONDA_PREFIX
@"
# Generated by build.ps1: PyInstaller's entry-point script must not share a
# name with a package it imports, or the package gets silently dropped from
# the bundle. --name iMolpro keeps the built .exe itself named iMolpro.
from iMolpro.__main__ import main

if __name__ == '__main__':
    main()
"@ | Out-File -Encoding utf8 _pyinstaller_entry.py
        ...
        --add-data=README.md:. `
          --add-data=doc:.\doc `
            ...
            --paths=$cp\Lib\site-packages `
              $pyinstaller_opt _pyinstaller_entry.py
Remove-Item _pyinstaller_entry.py
